$(document).ready(function () {
  ...
  const messages = [
    ...
    "hi! my name is twig!",
    "give me commit rights on your repo",
    "amen amen amen amen amen",
    "tell your friends! tell your coworkers!",
    "i love you",
    "if you are able and willing to give me 10000 dollars please hit me up",
    "i will never be productive",
    "whatever. Go my twigling",
    "man this pickel good",
    "it's my birthday!",
    "i am a cat sometimes",
    "i quite like pallas cats",
    "good morning usa",
    "breathe please",
    "i'm sleepy",
    "bro. memory. freaking. unlocked.",
    "u are a genius!",
    "you are the youngest person ever",
    "that bird that i hate",
    "shrimp on sale at this hour?",
    "i'm a big fan",
    "you are now in the mix with twerknation28",
    "shut up bro",
    "STOP CLICKING ME!",
    "...what?",
    "toby fox if you are reading this please contact me i am a big fan",
    "MANTITTIES IN YOUR FACE",
    "ƌᨓ ꔠƌφφɣ. ƌᨓ ⟟η ⍭ꭱơ⊔βℓ⋲. ηơ, ⍵ƌ⟟⍭. ƌᨓ ꔠƌφφɣ.",
    "do you ever feel like a hamster in venuzuela?",
    "✌︎👎︎👎︎☼︎☜︎💧︎💧︎ 💣︎☜︎",
    "everyone SHUT UP. i have something to say...",
    "dragdropclickchop",
    "when i'm washing dishes but i have an active imagination",
    "erm",
    "bruh.flp",
    "jpegs are kinda nostalgic for me",
    "ERRATAS",
    "the reizoko technique",
    "chiyojump",
    "STOP IT!",
    "what a nintendrone lol screw this guy",
    "more statistics please",
    "abstract... i like it...",
    "the const holding all of these is getting really long",
    "jeans remover",
    "i spent 2 hours on this bart simpson for nothing. no views i bet",
    "you just won the golden ticket! the prize is nothing do not contact me",
    ...
    "i love mario // jumping up and down clapping //",
    "...during no poop july?",
    "Oscilloscope meat gradient",
    "it's one in the morning...",
    ":chiyojump:",
    "Hello, I am looking for Twigchan...",
    "goodnight bro",
  ];
  ...
  $(miiCnr).on("click", function () {
    ...
    $("#speechBubble")
      .show()
      .animate(bubbleAnimation, 500, "easeOutCirc", async function () {
  ...
  function renderCarousel() {
    ...
    if ($container.find(".carouselItem").length === 0) {
      ...
      $container
        .find(".carouselItem")
        .replaceWith(carouselItems[currentCarouselIndex].html);
  ...
  $.getJSON(
    "https://api.lanyard.rest/v1/users/970448540335759461",
    function (data) {
      if (
        data.success &&
        data.data &&
        ...
        const activity = data.data.activities.find(
          (act) =>
            ...
            (!act.assets ||
              ...
              !act.assets.large_text.includes(
            ...
            if (activity.assets && activity.assets.large_image) {
              if (activity.assets.large_image.startsWith("mp:external/")) {
                imageUrl =
                  ...
                  activity.assets.large_image.replace("mp:external/", "");
              } else {
...
$(".statusContainer").on("click", function (e) {
  if (
    $(e.target).closest(".carouselNav, .carouselPrev, .carouselNext").length
  ) {
    return;
  }
  var $container = $(".statusContainer");
...
const aboutSections = [
  ...
  },
  {
    ...
    content: `<h2 class="about-section-title">Links</h2>
        ...
        <a href="https://bsky.app/profile/twig.fish" target="_blank">• Bluesky <img src="assets/img/bsky.svg" alt="Bluesky" style="width: 16px; height: 16px; vertical-align: middle;"></a><br>
